...
Используй `/create-plan [feature]` чтобы начать планирование новой фичи.
```
...
3. Запусти `/create-plan [первая фича]` чтобы начать разработку

### 💡 Рекомендуемые команды
- `/project-status` — проверить состояние проекта
- `/create-plan [feature]` — спланировать новую фичу
